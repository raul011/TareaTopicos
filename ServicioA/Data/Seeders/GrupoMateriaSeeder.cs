        ...
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<GrupoMateria>().HasData(
               // introducciona a la informatica
                new GrupoMateria { Id = 1, Grupo = "SB", Cupo = 1, Estado = "ACTIVO", MateriaId = 3, DocenteId = 97, PeriodoId = 1, HorarioId = 11, AulaId = 1 },
                new GrupoMateria { Id = 2, Grupo = "SD", Cupo = 1, Estado = "ACTIVO", MateriaId = 3, DocenteId = 57, PeriodoId = 1, HorarioId = 1, AulaId = 1 },
               ...
               //estructuras discretas
                new GrupoMateria { Id = 5, Grupo = "SF", Cupo = 1, Estado = "ACTIVO", MateriaId = 2, DocenteId = 55, PeriodoId = 1, HorarioId = 12, AulaId = 1 },
                new GrupoMateria { Id = 6, Grupo = "SH", Cupo = 1, Estado = "ACTIVO", MateriaId = 2, DocenteId = 56, PeriodoId = 1, HorarioId = 2, AulaId = 2 },
                ...
                new GrupoMateria { Id = 9, Grupo = "F1", Cupo = 1, Estado = "ACTIVO", MateriaId = 1, DocenteId = 9, PeriodoId = 1, HorarioId = 10, AulaId = 2 },
                new GrupoMateria { Id = 10, Grupo = "SG", Cupo = 1, Estado = "ACTIVO", MateriaId = 1, DocenteId = 16, PeriodoId = 1, HorarioId = 10, AulaId = 2 },
                ...
                new GrupoMateria { Id = 12, Grupo = "Z1", Cupo = 1, Estado = "ACTIVO", MateriaId = 5, DocenteId = 26, PeriodoId = 1, HorarioId = 10, AulaId = 2 },
                ...
                new GrupoMateria { Id = 14, Grupo = "Z1", Cupo = 1, Estado = "ACTIVO", MateriaId = 4, DocenteId = 63, PeriodoId = 1, HorarioId = 10, AulaId = 2 },
