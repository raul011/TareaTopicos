...
//         ServicioAContext db)
//     {
//         _qm = qm; _store = store; _cfg = cfg; _db = db;
//     }
...
//             Grupo = N(dto.Grupo),
//             AutoCrearInscripcion = true // el worker hace upsert del header si no existe
//         };

//         var tx = new Transaccion
//         {
//             TipoOperacion = "POST",
//             Entidad = "DetalleInscripcion",
...
//     // Permite cambiar de grupo (A->B) o cambiar estado (INSCRITO->RETIRADO)
